	...
	<body>
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1>Daftar Jenis Hero <a href="<?php echo site_url()?>/Jenis_Hero/addData" class="btn btn-warning"><span class="glyphicon glyphicon-plus"></span> Tambah Jenis Hero</a> </h1>	
